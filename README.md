...
0. [**Introduction**: Why Counting Isn't as Simple as 1, 2, 3](00-introduction.md)
1. [**Chapter 1**: Base-10 (Decimal) — The System You Never Knew You Chose](01-decimal.md)
2. [**Chapter 2**: Base-2 (Binary) — The Language of Computers](02-binary.md)
3. [**Chapter 3**: Base-8 (Octal) — The Forgotten Middle Child](03-octal.md)
4. [**Chapter 4**: Base-16 (Hexadecimal) — Programmer's Best Friend](04-hexadecimal.md)
5. [**Chapter 5**: Base-12 (Duodecimal) — Ancient Wisdom](05-duodecimal.md)
6. [**Chapter 6**: Base-60 (Sexagesimal) — The Babylonian Legacy](06-sexagesimal.md)
7. [**Chapter 7**: Other Bases and Practical Applications — The Variety Show](07-other-bases.md)
8. [**Chapter 8**: Conclusion — Counting the Ways](08-conclusion.md)
...
Ready to begin? Start with the [Introduction](00-introduction.md).
